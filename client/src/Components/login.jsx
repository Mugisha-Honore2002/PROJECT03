...
export default function LoginPage() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (selectedRole === "Teacher") window.location.href = "/teacher/dashboard";
      if (selectedRole === "Supervisor") window.location.href = "/supervisor/dashboard";
      ...
      <div className="flex items-center justify-center w-full px-8 py-16 lg:w-1/2">
        <div className="w-full max-w-md">
          ...
          <p className="mt-6 text-sm text-center text-slate-400">
            ...
            <Link to="/" className="font-medium text-indigo-500 transition-colors hover:text-indigo-700">
              Create one
            </Link>
          </p>
